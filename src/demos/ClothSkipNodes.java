...
public class ClothSkipNodes extends PApplet {
    ...
    private void resetSystem() {
        ...
        gridThreadPointMassSystem.air = new Air(0.06f, 0.01f, Vec3.of(0, 0, 1), 0);
    }
    ...
    static public void main(String[] passedArgs) {
        String[] appletArgs = new String[]{"demos.ClothSkipNodes"};
        if (passedArgs != null) {
