...
public class Checkin extends PApplet {
    ...
    public void setup() {
        ...
        seriesThreadMassSystem1 = SeriesThreadMassSystem.random(this, Vec3.of(-60, -60, -200), 4, 120, 20, 200, 30f, (i, m) -> i == 0);
        seriesThreadMassSystem2 = SeriesThreadMassSystem.random(this, Vec3.of(-30, -60, -200), 4, 60, 20, 200, 30f, (i, m) -> i == 0);
        seriesThreadMassSystem3 = SeriesThreadMassSystem.random(this, Vec3.of(0, -60, -200), 4, 10, 20, 200, 30f, (i, m) -> i == 0);
        seriesThreadMassSystem4 = SeriesThreadMassSystem.random(this, Vec3.of(30, -60, -200), 4, 60, 20, 200, 30f, (i, m) -> i == 0);
        seriesThreadMassSystem5 = SeriesThreadMassSystem.random(this, Vec3.of(60, -60, -200), 4, 120, 20, 200, 30f, (i, m) -> i == 0);
    }
